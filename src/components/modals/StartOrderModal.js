...
const StartOrderModal = ({ handleStartOrder, handleCloseStartOrderModal, showStartOrderModal }) => {
    return (
        <div>
            {showStartOrderModal && (
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Please Click 'OK' to proceed to start the timer.Make sure to deliver the order on time.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-5 sm:mt-6">
                                ...
                                <button
                                    ...
                                    onClick={handleCloseStartOrderModal}
                                >
                                    No
                                </button>
                            </div>
